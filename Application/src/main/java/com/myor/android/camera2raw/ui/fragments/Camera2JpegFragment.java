 ...
 * </ul>
 */
public class Camera2JpegFragment extends Fragment
     ...
     */
    private static final String TAG = "Camera2JpegFragment";
    ...
    // private static Bitmap previewBitmapPicture;
    ...
    /*
    private static void saveBitmapInMemory(byte[] bytes) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inSampleSize = 8;

        try {
            previewBitmapPicture = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
        }
        catch (Exception ex) {
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request,
            ...
            synchronized (mCameraStateLock) {
                ...
                if (jpegBuilder != null) {
                    savedLocation = jpegBuilder.getSaveLocation();

                    jpegBuilder.setResult(result);
                    sb.append("Saving JPEG as: ");
                    sb.append(savedLocation);
                }
           ...
           // NavHostFragment.findNavController(this).navigate(R.id.jpegFragment);

           // Navigation.findNavController(getActivity(), R.id.picture).navigate(R.id.handPhotoInstructionsFragment);
        }
    ...
    public static Camera2JpegFragment newInstance() {
        return new Camera2JpegFragment();
    }
    ...
    private boolean setUpCameraOutputs() {
        ...
        try {
            // Find a CameraDevice and configure state.
            for (String cameraId : manager.getCameraIdList()) {
                ...
                synchronized (mCameraStateLock) {
                    // Set up ImageReaders for JPEG output.  Place these in a reference
    ...
    private static class ImageSaver implements Runnable {
        ...
        /**
         * Builder class for constructing {@link Camera2JpegFragment.ImageSaver}s.
         * <p/>
        ...
        public static class ImageSaverBuilder {
            ...
            public synchronized Camera2JpegFragment.ImageSaver buildIfComplete() {
                if (!isComplete()) {
                    return null;
                }
                return new Camera2JpegFragment.ImageSaver(mImage, mFile, mCaptureResult, mCharacteristics, mContext,
                        mReader);
            }
